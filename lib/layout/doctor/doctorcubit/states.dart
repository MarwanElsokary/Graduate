...
class doctorGetuserErrorState extends doctorLayoutstates {
  final String error;
...
class imageAnalysisSuccessState extends doctorLayoutstates {
  final String imagePath;

  imageAnalysisSuccessState(this.imagePath);
}

class imageAnalysisUpdateState extends doctorLayoutstates {}
...
class doctorNewPostErrorState extends doctorLayoutstates {
  final String error;
...
class isMaxilloFacial extends doctorLayoutstates {}

class isfullmouth extends doctorLayoutstates {}

class loadingLabels extends doctorLayoutstates {}

class sucessloadingLabels extends doctorLayoutstates {}
...
class doctorGetCasesErrorState extends doctorLayoutstates {
  final String error;
...
class doctorUpdateCasesErrorState extends doctorLayoutstates {
  final String error;
...
class doctorDeleteCasesErrorState extends doctorLayoutstates {
  final String error;
...
class doctorGetClickedCaseErrorState extends doctorLayoutstates {
  final String error;
