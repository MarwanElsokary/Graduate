...
WidgetsFlutterBinding.ensureInitialized();
   ...
   admin = FirebaseAdmin.instance.initializeApp(AppOptions(
    credential:
        ServiceAccountCredential.fromJson(
        {
                    ...
                    "client_email": "firebase-adminsdk-pf9ht@easy-patient-finder.iam.gserviceaccount.com",
                    "client_id": "109959152849471817138",
                    "auth_uri": "https://accounts.google.com/o/oauth2/auth",
                    "token_uri": "https://oauth2.googleapis.com/token",
                    "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
                    "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-pf9ht%40easy-patient-finder.iam.gserviceaccount.com"
                  }
...
FirebaseMessaging.onMessage.listen((RemoteMessage message) {
  if (message.notification != null) {
    print('xxxxxx');
    showtoast(text: ' ${message.notification!.body!.toLowerCase()}', state: toaststates.WARNNING);
  }
});
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
     return MultiBlocProvider(
      providers: [
        BlocProvider(create:(context) => adminLayoutcubit()..getStudents()..getDoctors()..getSupervisors()),
